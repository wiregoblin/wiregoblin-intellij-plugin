...
internal object WireGoblinWorkflowRunner {
    ...
    private fun runOrStop(
        ...
        try {
            val profile = WireGoblinRunProfile(project, runName, commandLine, key, runningWorkflow)
    ...
    private fun restartLineMarkers(project: Project) {
